...
# guidance_scale = 7.5
# image_num = args.image_num
negative_prompt = "text, watermark, lowres, low quality, worst quality, deformed, glitch, low contrast, noisy, saturation, blurry, character, people, robot, human, couple, woman, man, child, baby, boy, girl, kid, adult, old, young, piano, road, word, title"
